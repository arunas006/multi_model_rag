...
from ingestion.api.dependency import (
    get_embedder_dep,
    get_openai_client,
    get_reranker_dep,
    get_store,
)
from ingestion.api.schema import ChunkResult, GenerateRequest, GenerateResponse
    ...
    try:
        completion = await client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": _build_user_context(context, req.query, candidates)},  # type: ignore[misc,list-item]
            ],
