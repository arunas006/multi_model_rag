...
from ingestion.api.dependency import get_embedder_dep, get_reranker_dep, get_store
from ingestion.api.schema import ChunkResult, SearchRequest, SearchResponse
...
async def search(req: SearchRequest) -> SearchResponse:
    """Search for chunks in a Qdrant collection."""
    ...
    top_n = req.top_n if req.top_n else settings.reranker_top_n
