...
from ingestion.api.schema import HealthResponse,DeleteCollectionResponse,CollectionsResponse
from ingestion.api.dependency import get_openai_client,get_store
...
async def health() -> HealthResponse:
    ...
    overall = "Healthy" if qdrant_status == "ok" and openai_status == "ok" else "degraded"
